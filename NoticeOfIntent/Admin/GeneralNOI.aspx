<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/CLFNested.master" CodeBehind="GeneralNOI.aspx.vb" Inherits="NoticeOfIntent.GeneralNOI" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="NestedContentPlaceHolderBody" runat="server">
    ...
    <div class="panel panel-default panel-warning text-warning">
        <div class="panel-body font-bold">
            <p>
                Validation is been enabled for this page by default. To disable the validation for this page please check the below checkbox.
            </p>
            <p class="clearfix">
                <asp:CheckBox ID="chkPageValidationEnable" runat="server" Text="Enable page validation" Checked="true" CssClass="checkbox" AutoPostBack="true" />
            </p>
        </div>
    </div>
    <div>
        ...
        <asp:Wizard ID="wzNOI" runat="server" CssClass="table table-bordered" ActiveStepIndex="0" DisplayCancelButton="True" >
            <SideBarStyle CssClass="col-md-3" />
            <NavigationButtonStyle CssClass="btn btn-default" />
            <WizardSteps>
                <asp:WizardStep ID="ApplicantInfo" runat="server" Title="Applicant Information" StepType="Start">
                    <div class="panel-group" id="appinfoaccordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#ownerdetails">
                                    <h1 class="panel-title font-bold">Owner Information<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#contactdetails">
                                    <h1 class="panel-title font-bold">
                                        <asp:Label ID="lblContactInfoHeading" runat="server" Text="Contact Information"></asp:Label><span class="pull-right glyphicon glyphicon-chevron-down"></span></h1>
                                </a>
                            </div>
                            <div id="contactdetails" class="panel-collapse collapse">
                                <div class="panel-body input-group-sm">
                                    ...
                                    <uc1:ucNameAddressInfo ID="ucnaContactInfo" runat="server" controlname="Contact Information" companytypevisible="false" ValidateCompanyName="false" countymunicipalityvisible="false" ValidationGroup="ValidateNOI" />
                                </div>
                            </div>
                        </div>
                        <div id="divBilleeDetails" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#billeedetails">
                                    <h1 class="panel-title font-bold">Billing Information<span class="pull-right glyphicon glyphicon-chevron-down"></span></h1>
                                </a>
                            </div>
                            <div id="billeedetails" class="panel-collapse collapse">
                                <div class="panel-body input-group-sm">
                                    ...
                                    <div class="clearfix"></div>
                                    <uc1:ucNameAddressInfo ID="ucnaBilleeInfo" runat="server" controlname="Payee Information" companytypevisible="false" ValidateCompanyName="false" countymunicipalityvisible="false" ValidationGroup="ValidateNOI" />
                                </div>
                            </div>
                        </div>
                    </div>
                </asp:WizardStep>
                <asp:WizardStep ID="ProjectInfo" runat="server" Title="Project Information" StepType="Step">
                    <div class="panel-group" id="projectinfoaccordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#siteinfo">
                                    <h1 class="panel-title font-bold"><asp:Label ID="lblSiteInfoPnlHeading" runat="server" Text="Site Information"></asp:Label><span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="siteinfo" class="panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <uc1:ucNameAddressInfo ID="ucnaSiteInfo" runat="server" controlname="Site Information" allowDEstateonly="True" usercontroltype="project" companytypevisible="false" emailvisible="false" personnamevisible="false" address2visible="false" phonevisible="false" CompanyNameLabel="Project Name" Address1Label="Project Location/Address" ValidationGroup="ValidateNOI" />
                                        </div>
                                    </div>
                        ...
                        <div id="divTaxParcel" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#taxparceldiv">
                                    <h1 class="panel-title font-bold">Tax Parcel Information<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="taxparceldiv" class="panel- panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvTaxparcel" DataKeyNames="ProjectTaxParcelID,PIID" ItemType="NoticeOfIntent.NOITaxParcel" SelectMethod="GetTaxParcelLst" runat="server" InsertItemPosition="LastItem" InsertMethod="lvTaxparcel_InsertItem" DeleteMethod="lvTaxparcel_DeleteItem">
                                        <LayoutTemplate>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:ImageButton ID="ibtnDelete" AlternateText="Delete" runat="server" CssClass="btn-xs" CommandName="Delete" CommandArgument="<%#: Item.ProjectTaxParcelID %>" ImageUrl="~/Content/images/Delete.png" ToolTip="Delete the taxparcel" OnClientClick="javascript:return confirm('Are you sure to delete?')" CausesValidation="false" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                        ...
                        <div id="divLocDet" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#siteloc">
                                    <h1 class="panel-title font-bold">Site Location<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
...
<%--                                    <div class="form-inline">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 input-group-sm">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvLatitude" ControlToValidate="txtLatitude" runat="server" Display="Dynamic" EnableClientScript="true" CssClass="alert-text" ToolTip="Latitude is required" ErrorMessage="Latitude is required. Click Map Point button to select a point." ValidationGroup="ValidateNOI">*</asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-6 input-group-sm">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvLongitude" ControlToValidate="txtLongitude" runat="server" Display="Dynamic" EnableClientScript="true" CssClass="alert-text" ToolTip="Longitude is required" ErrorMessage="Longitude is required. Click Map Point button to select a point." ValidationGroup="ValidateNOI">*</asp:RequiredFieldValidator>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 input-group-sm">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvWatershed" ControlToValidate="txtWatershed" runat="server" Display="Dynamic" EnableClientScript="true" CssClass="alert-text" ToolTip="Watershed is required" ErrorMessage="Watershed is required. Click Map Point button to select a point." ValidationGroup="ValidateNOI">*</asp:RequiredFieldValidator>
                        ...
                        <div id="divbmp" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#SWBMPdiv">
                                    <h1 class="panel-title font-bold">Stormwater Management Practices Proposed<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="SWBMPdiv" class="panel- panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvSWBMP" DataKeyNames="PermitID,PIID,SWBMPID" ItemType="NoticeOfIntent.SWConstructBMP"  SelectMethod="GetProjectSWBMPLst" runat="server" InsertItemPosition="LastItem" InsertMethod="lvSWBMP_InsertItem" DeleteMethod="lvSWBMP_DeleteItem">
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblBMPName" runat="server" Text='<%#: Item.SWBMPName%>'></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:ImageButton ID="ibtnDelete" AlternateText="Delete" runat="server" CssClass="btn-xs" CommandName="Delete"  CommandArgument='<%#: Item.PermitID.ToString() + "," + Item.SWBMPID.ToString() %>' ImageUrl="~/Content/images/Delete.png" ToolTip="Delete the BMP" OnClientClick="javascript:return confirm('Are you sure to delete?')" CausesValidation="false" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <AlternatingItemTemplate>
                ...
                <asp:WizardStep ID="ProjectInfo1" runat="server" Title="Project Information (continued)" StepType="Finish">
                    <div class="panel-group" id="projectinfo1accordion">
                        <div id="divOtherInfo" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#otherinfo">
                                    <h1 class="panel-title font-bold">Other Information<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="otherinfo" class="panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 input-group-sm">
                                            <asp:Label ID="lblAreaOfSite" AssociatedControlID="txtTotalAreaOfSite" runat="server" Text="Total Land Area of Site:" CssClass="control-label"></asp:Label>
                                        ...
                                        <div class="col-md-6 input-group-sm">
                                            <asp:Label ID="lblAreaOfDisturbed" AssociatedControlID="txtAreaOfDisturbed" runat="server" Text="Est. Area to be Disturbed:" CssClass="control-label"></asp:Label>
                        ...
                        <div id="divSicCodes" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#SICdiv">
                                    <h1 class="panel-title font-bold">SIC Codes<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="SICdiv" class="panel- panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvSIC" DataKeyNames="PiID,SIC" ItemType="NoticeOfIntent.NOIPiSIC" SelectMethod="GetSubmissionSICCodes" runat="server" InsertItemPosition="LastItem" InsertMethod="lvSIC_InsertItem" DeleteMethod="lvSIC_DeleteItem">
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblSICCode" runat="server" Text='<%#: Item.SIC%>'></asp:Label>
                                                </td>
                                                <td>
                                        ...
                                        <InsertItemTemplate>
                                            <tr class="insertfooter">
                                                <td>
                                                    <asp:TextBox ID="txtSICCode" runat="server" CssClass="form-control" Text="<%#: BindItem.SIC %>" ClientIDMode="Static"></asp:TextBox>
                        ...
                        <div id="divNAICSCodes" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#NAICSdiv">
                                    <h1 class="panel-title font-bold">NAICS Codes<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="NAICSdiv" class="panel- panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvNAICS" DataKeyNames="PiID,NAICS" ItemType="NoticeOfIntent.NOIPiNAICS" SelectMethod="GetSubmissionNAICSCodes" runat="server" InsertItemPosition="LastItem" InsertMethod="lvNAICS_InsertItem" DeleteMethod="lvNAICS_DeleteItem">
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblNAICSCode" runat="server" Text='<%#: Item.NAICS%>'></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblRank" runat="server" Text='<%#: Item.RankCode%>'></asp:Label>
                                                </td>
                                        ...
                                        <InsertItemTemplate>
                                            <tr class="insertfooter">
                                                <td>
                                                    <asp:TextBox ID="txtNAICSCode" runat="server" CssClass="form-control" Text="<%#: BindItem.NAICS %>" ClientIDMode="Static"></asp:TextBox>
                        ...
                        <div id="divOutfall" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#PermittedFeaturediv">
                                    <h1 class="panel-title font-bold">Outfall Collection<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="PermittedFeaturediv" class="panel panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvOutfall" DataKeyNames="UnitID,PiID" runat="server" ItemType="NoticeOfIntent.NOIOutfall" SelectMethod="lvOutfall_GetData" InsertMethod="lvOutfall_InsertItem" DeleteMethod="lvOutfall_DeleteItem" InsertItemPosition="LastItem">
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                        ...
                                        <InsertItemTemplate>
                                            <tr class="insertfooter">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtoutfallLatitude" runat="server" ClientIDMode="Static" CssClass="form-control" Text="<%#: BindItem.Latitude %>"></asp:TextBox>
                                                    <asp:HiddenField ID="hfoutfallX" runat="server" ClientIDMode="Static" Value="<%#: BindItem.X %>" />
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtoutfallLongitude" runat="server" ClientIDMode="Static"  CssClass="form-control" Text="<%#: BindItem.Longitude %>"></asp:TextBox>
                                                    <asp:HiddenField ID="hfoutfallY" runat="server" ClientIDMode="Static" Value="<%#: BindItem.Y %>" />
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtoutfallWatershed" runat="server" ClientIDMode="Static"  CssClass="form-control" Text="<%#: BindItem.Watershed %>"></asp:TextBox>
                                                    <asp:HiddenField ID="hfoutfallWaterShedCode" runat="server" ClientIDMode="Static" Value="<%#: BindItem.HUC12 %>" />
                        ...
                        <div id="divPesticidesEntity" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#Entityinfo">
                                    <h1 class="panel-title font-bold">Type Of Entity<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="Entityinfo" class="panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <div class="col-md-12">
                                        <div class="radio">
                                            <asp:RadioButtonList ID="rblEntityType" runat="server" ItemType="NoticeOfIntent.NOIEntityType" DataTextField="EntityTypeDesc" DataValueField="EntityTypeID" SelectMethod="rblEntityType_GetData"  ClientIDMode="Static" AutoPostBack="true"></asp:RadioButtonList>
                        ...
                        <div id="divPesticidesThreshold" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#Thresholdinfo">
                                    <h3 class="panel-title font-bold">Does this entity exceed the Annual Treatment Threshold identified in §9.8.2 of the Regulations Governing Discharges from the Application of Pesticides to Waters of the State? 
                                                                                        *The Annual Treatment Thresholds identified in §9.8.2 are as follows*<span class="pull-right glyphicon glyphicon-chevron-up"></span></h3>
                        ...
                        <div id="divChemicals" runat="server" class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#Chemicalsinfo">
                                    <h1 class="panel-title font-bold">Chemicals Used in Operation (Note: a change in use of active ingredient or a change in annual average totals that vary by more than 15% as indicated on NOI will require NOI resubmission)<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="Chemicalsinfo" class="panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvAPChemicals" DataKeyNames="APChemicalID,PermitID,Ingredient" runat="server" ItemType="NoticeOfIntent.NOIAPChemicals" SelectMethod="lvAPChemicals_GetData" InsertMethod="lvAPChemicals_InsertItem" DeleteMethod="lvAPChemicals_DeleteItem" InsertItemPosition="LastItem" UpdateMethod="lvAPChemicals_UpdateItem" >
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                                        <th class="col-sm-3">Ingredient (not specific product name)</th>
                                        ...
                                        <InsertItemTemplate>
                                            <tr class="insertfooter">
                                                <td colspan="6" class="panel-group">
                                                    <div class="panel panel-default">
                                                        <div class="panel panel-heading">
                                                            <a data-toggle="collapse" href="#pnlChemical1">
                                                        ...
                                                        <div id="pnlChemical1" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <div class="form-group form-group-sm">
                                                                    <div class="row">
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <asp:TextBox ID="txtIngredient" runat="server" CssClass="form-control" Text='' ClientIDMode="Static"></asp:TextBox>
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <asp:DropDownList ID="ddlPesticidePattern" runat="server" CssClass="form-control" ItemType="NoticeOfIntent.NOIPesticidePattern" SelectMethod="GetPesticidePatterns" DataTextField="PesticidePattern" DataValueField="PesticidePatternID" ClientIDMode="Static" AppendDataBoundItems="true">
                                                                                <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                                     ...
                                                                     <div class="row">
                                                                        <div class="col-sm-4">
                                                                             <label class="control-label">Application Rate:</label>
                                                                            <div class="form-inline">
                                                                                 <asp:TextBox ID="txtApplicationRate" runat="server" CssClass="form-control" Text=" " ClientIDMode="Static"></asp:TextBox>
                                                                                <asp:DropDownList ID="ddlApplicationRateUnit" runat="server" CssClass="dropdown" ClientIDMode="Static" >
                                                                                    <asp:ListItem Text="gal/acre" Value="gal/acre"></asp:ListItem>
                                                                                    <asp:ListItem Text="lbs/acre" Value="lbs/acre"></asp:ListItem>
                                                                                    <asp:ListItem Text="gal/mile" Value="gal/mile"></asp:ListItem>
                                                                                    <asp:ListItem Text="oz/acre" Value="oz/acre"></asp:ListItem>
                                                                         ...
                                                                         <div class="col-sm-4">
                                                                            <label class="control-label">Annl. average amount used:</label>
                                                                            <div class="form-inline">                                                           
                                                                                <asp:TextBox ID="txtAnnlAvgQty" runat="server" CssClass="form-control" Text=" " ClientIDMode="Static"></asp:TextBox>
                                                                                <asp:DropDownList ID="ddlAnnlAvgQtyUnit" runat="server" CssClass="dropdown"  ClientIDMode="Static" >
                                                                                    <asp:ListItem Text="gal" Value="gal"></asp:ListItem>
                                                                                    <asp:ListItem Text="lbs" Value="lbs"></asp:ListItem>
                                                                                    <asp:ListItem Text="oz" Value ="oz"></asp:ListItem>
                                                                                    <asp:ListItem Text="Tablets" Value="Tablets"></asp:ListItem>
                                                                         ...
                                                                         <div class="col-sm-4">                                                                 
                                                                            <label class="control-label">Annual average area:</label>
                                                                            <div class="form-inline">
                                                                                <asp:TextBox ID="txtAnnlAvgArea" runat="server" CssClass="form-control" Text=" " ClientIDMode="Static"></asp:TextBox>
                                                                                ...
                                                                                <asp:DropDownList ID="ddlAnnlAvgAreaUnit" runat="server" CssClass="dropdown"  ClientIDMode="Static"  >
                                                                                    <asp:ListItem Text="acres" Value="acres"></asp:ListItem>
                                                                                    <asp:ListItem Text="miles" Value="miles"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a data-toggle="collapse" href="#statusinfo">
                                    <h1 class="panel-title font-bold">Status Information<span class="pull-right glyphicon glyphicon-chevron-up"></span></h1>
                                </a>
                            </div>
                            <div id="statusinfo" class="panel-collapse collapse in">
                                <div class="panel-body input-group-sm">
                                    <asp:ListView ID="lvStatus" runat="server" DataKeyNames="PEventsID,PermitID" ItemType="NoticeOfIntent.PermitStatus" InsertItemPosition="LastItem" InsertMethod="lvStatus_InsertItem" DeleteMethod="lvStatus_DeleteItem" SelectMethod="lvStatus_GetData">
                                        <LayoutTemplate>
                                            <table class="table table-bordered table-hover table-condensed">
                                                <thead>
                                                    <tr>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <%#: Item.PEventDate.ToString("MM/dd/yyyy") %>
                                                </td>
                                                <td>
                                                    <%#: Item.PEvent%>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:ImageButton ID="ibtnDeleteStatus" AlternateText="Delete" runat="server" CssClass="btn-xs" CommandName="Delete" Enabled="false" CommandArgument='<%#: Item.PEventsID.ToString() %>' ImageUrl="~/Content/images/Delete.png" ToolTip="Delete the Permit Status" OnClientClick="javascript:return confirm('Are you sure to delete?')" CausesValidation="false" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <AlternatingItemTemplate>
                                        ...
                                        <InsertItemTemplate>
                                            <tr class="insertfooter">
                                                <td>
                                                    <asp:TextBox ID="txtStatusDate" runat="server" CssClass="form-control datepicker" MaxLength="10" ClientIDMode="Static" Text="<%#: BindItem.PEventDate %>"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvStatusDate" runat="server" ControlToValidate="txtStatusDate" ErrorMessage="Status Date is required" ToolTip="Status Date is required" Display="Dynamic" EnableClientScript="true" CssClass="alert-text" ValidationGroup="ValidateStatus"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control" ItemType="NoticeOfIntent.PermitStatusCodeLst" SelectMethod="GetPermitStatusCodeLst" DataTextField="PEvent" DataValueField="PEventCode" ClientIDMode="Static"  SelectedValue="<%#: BindItem.PEventCode %>" AppendDataBoundItems="true">
                                                        <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="rfvddlStatus" runat="server" ControlToValidate="ddlStatus" Display="Dynamic" EnableClientScript="true" CssClass="alert-text" ErrorMessage="Status is required." ToolTip="Status is required." ValidationGroup="ValidateStatus" InitialValue="0"  >*</asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtComment" runat="server" CssClass="form-control" Text="<%#: BindItem.PEventComment %>" ClientIDMode="Static"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnInsertstatus" runat="server" CommandName="Insert" CssClass="btn btn-default" Text="Add Permit Status"  ClientIDMode="Static" ValidationGroup="ValidateStatus"/>
                                                </td>
                                            </tr>
                                        </InsertItemTemplate>
                                        <EmptyDataTemplate>
                                            <table class="table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="3">Status is not available</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </EmptyDataTemplate>
        ...
        <asp:HiddenField ID="hfSavedSuccessfull" runat="server" Value="0" ClientIDMode="Static" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="NestedContentPlaceHolderJS" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            //$('#ContentPlaceHolderBody_NestedContentPlaceHolderBody_wzNOI_ucnaSiteInfo_txtZip').on("change", function (e) {
            //    e.preventDefault();
