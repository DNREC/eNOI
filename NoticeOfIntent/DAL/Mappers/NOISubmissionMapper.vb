Public Class NOISubmissionMapper
    ...
    Public Sub New()
        ...
        Me.HasMany(Function(e) e.NOISubmissionSWBMP) _
           .WithRequired(Function(e) e.NOISubmission) _
           .WillCascadeOnDelete(True)
        ...
        Me.HasOptional(Function(e) e.NOISubmissionSWConstruct) _
               .WithRequired(Function(e) e.NOISubmission) _
              .WillCascadeOnDelete(True)

        Me.HasOptional(Function(e) e.NOISubmissionSW) _
            .WithRequired(Function(e) e.NOISubmission) _
            .WillCascadeOnDelete(True)
